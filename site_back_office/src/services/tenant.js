 ...
 * Example: hood-family-farms.office.hoodfamilyfarms.com
 * 
 ...
 * @param {string} appName - The app subdomain (e.g., 'office', 'herds')
 * @returns {string} The full URL for that tenant
 */
export const getTenantUrl = (tenantSlug, appName = 'office') => {
  if (isDevelopment()) {
